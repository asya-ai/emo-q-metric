...
# python run_predict.py --mode predict_dir --pretrained_model weights/nisqa_tts.tar --data_dir /media/storage_2/data/raw/tts_validation/en/gemini_tts_valid_output --num_workers 2 --bs 10 --output_dir /media/storage_2/data/raw/tts_validation/en/gemini_tts_valid_output
